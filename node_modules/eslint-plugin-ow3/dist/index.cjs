...
const utils$1 = require('@typescript-eslint/utils');
...
const genericSpacing = utils.createEslintRule({
  name: RULE_NAME$7,
  meta: {
    type: "suggestion",
    docs: {
...
const ifNewline = utils.createEslintRule({
  name: RULE_NAME$6,
  meta: {
    type: "problem",
    docs: {
...
const importDedupe = utils.createEslintRule({
  name: RULE_NAME$5,
  meta: {
    type: "problem",
    docs: {
...
const preferInlineTypeImport = utils.createEslintRule({
  name: RULE_NAME$4,
  meta: {
    type: "suggestion",
    docs: {
...
const topLevelFunction = utils.createEslintRule({
  name: RULE_NAME$3,
  meta: {
    type: "problem",
    docs: {
...
const orderClasses = utils$1.ESLintUtils.RuleCreator((name) => name)({
  name: "order",
  meta: {
    type: "layout",
    fixable: "code",
...
const noTsExportEqual = utils.createEslintRule({
  name: RULE_NAME$2,
  meta: {
    type: "problem",
    docs: {
...
const noCjsExports = utils.createEslintRule({
  name: RULE_NAME$1,
  meta: {
    type: "problem",
    docs: {
...
const noConstEnum = utils.createEslintRule({
  name: RULE_NAME,
  meta: {
    type: "problem",
    docs: {
